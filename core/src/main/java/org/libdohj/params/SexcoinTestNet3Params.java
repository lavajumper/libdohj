...
/**
 * Parameters for the Sexcoin testnet, a separate public network that has
 * relaxed rules suitable for development and testing of applications and new
 * Sexcoin versions.
 */
public class SexcoinTestNet3Params extends AbstractSexcoinParams {
    ...
    public SexcoinTestNet3Params() {
        ...
        checkState(genesisHash.equals("73dc70a1698579360b62e724ecfeacfd938f45283162f3cf18f1b9eb3fc9fcd7"));
        ...
        // chain agnostic. Sexcoin mainnet has its own headers for legacy reasons.
        bip32HeaderPub = 0x043587CF;
        bip32HeaderPriv = 0x04358394;
    }

    private static SexcoinTestNet3Params instance;

    public static synchronized SexcoinTestNet3Params get() {
        if (instance == null) {
            instance = new SexcoinTestNet3Params();
        }
        return instance;
    }
