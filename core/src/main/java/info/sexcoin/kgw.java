...
public class kgw {
    ...
    static {
        try {
            System.loadLibrary("kgw_sexcoin");
    ...
    public static native int KimotoGravityWell_init(long _TargetBlocksSpacingSeconds, long _PastBlocksMin, long _PastBlocksMax, double deviationDenominator, int kgwFixHeight, long LatestBlockTime);
