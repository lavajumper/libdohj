 ...
 * a wallet app, look at {@link info.sexcoin.sexcoinj.protocols.payments.PaymentSession} for a higher level API that should simplify working with the protocol.</p>
 *
...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/vnd.sxc.payment.request";
    public static final String MIMETYPE_PAYMENT = "application/vnd.sxc.payment.payment";
    public static final String MIMETYPE_PAYMENTACK = "application/vnd.sxc.payment.ack";
     ...
     * @return instance of {@link info.sexcoin.sexcoinj.protocols.payments.PaymentSession}, used as a value object
     * @throws info.sexcoin.sexcoinj.protocols.payments.PaymentProtocolException
     */
    public static info.sexcoin.sexcoinj.protocols.payments.PaymentSession parsePaymentRequest(Protos.PaymentRequest paymentRequest)
            throws info.sexcoin.sexcoinj.protocols.payments.PaymentProtocolException {
     ...
     * @throws info.sexcoin.sexcoinj.protocols.payments.PaymentProtocolException if payment request could not be verified.
     */
    public static @Nullable
    info.sexcoin.sexcoinj.protocols.payments.PaymentProtocol.PkiVerificationData verifyPaymentRequestPki(Protos.PaymentRequest paymentRequest, KeyStore trustStore)
            throws info.sexcoin.sexcoinj.protocols.payments.PaymentProtocolException {
        ...
        try {
            ...
            if (pkiType.equals("x509+sha256"))
                ...
                throw new info.sexcoin.sexcoinj.protocols.payments.PaymentProtocolException.InvalidPkiType("Unsupported PKI type: " + pkiType);
            ...
            if (protoCerts.getCertificateCount() == 0)
                throw new info.sexcoin.sexcoinj.protocols.payments.PaymentProtocolException.InvalidPkiData("No certificates provided in message: server config error");
            ...
            if (!signature.verify(paymentRequest.getSignature().toByteArray()))
                throw new info.sexcoin.sexcoinj.protocols.payments.PaymentProtocolException.PkiVerificationException("Invalid signature, this payment request is not valid.");
            ...
            if (displayName == null)
                throw new info.sexcoin.sexcoinj.protocols.payments.PaymentProtocolException.PkiVerificationException("Could not extract name from certificate");
            // Everything is peachy. Return some useful data to the caller.
            return new info.sexcoin.sexcoinj.protocols.payments.PaymentProtocol.PkiVerificationData(displayName, publicKey, result.getTrustAnchor());
        } catch (InvalidProtocolBufferException e) {
            // Data structures are malformed.
            throw new info.sexcoin.sexcoinj.protocols.payments.PaymentProtocolException.InvalidPkiData(e);
        } catch (CertificateException e) {
            // The X.509 certificate data didn't parse correctly.
            throw new info.sexcoin.sexcoinj.protocols.payments.PaymentProtocolException.PkiVerificationException(e);
            ...
            throw new info.sexcoin.sexcoinj.protocols.payments.PaymentProtocolException.PkiVerificationException(e, certs);
    ...
    public static class PkiVerificationData {
        ...
        private PkiVerificationData(@Nullable String displayName, PublicKey merchantSigningKey,
                                    TrustAnchor rootAuthority) throws info.sexcoin.sexcoinj.protocols.payments.PaymentProtocolException.PkiVerificationException {
            try {
     ...
     */
    public static info.sexcoin.sexcoinj.protocols.payments.PaymentProtocol.Ack parsePaymentAck(Protos.PaymentACK paymentAck) {
        final String memo = paymentAck.hasMemo() ? paymentAck.getMemo() : null;
        return new info.sexcoin.sexcoinj.protocols.payments.PaymentProtocol.Ack(memo);
    }
